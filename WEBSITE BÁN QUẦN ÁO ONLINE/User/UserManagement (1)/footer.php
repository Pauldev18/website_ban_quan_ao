<div class="container-fluid footer">
  <div class="row footer-content">
    ...
    <div class="col-md-4 col-sm-12">
      ...
      <a class="btn dx-inline" href="https://www.facebook.com/iamdeveloper18"><i class="fab fa-facebook"></i></a>
      <a class="btn dx-inline" href="#"><i class="fab fa-instagram"></i></a>
    </div>
    <div class="col-md-3 col-sm-12">
      <h5>TRUY CẬP NHANH</h5>
      <hr style="width: 55%;">
      <a class="link-shortcut" href="http://localhost/QuanLyDoGiaDung/DoGiaDung/User/"> <i
          class="fas fa-chevron-circle-right"></i>Trang Chủ</a>
      <a class="link-shortcut"
        href="http://localhost/QuanLyDoGiaDung/DoGiaDung/User/UserManagement%20(1)/SaleProduct.php"> <i
