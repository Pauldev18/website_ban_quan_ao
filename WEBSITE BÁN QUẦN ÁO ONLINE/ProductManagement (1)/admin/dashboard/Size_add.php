...
<body style="margin-left:100px;background-color: #f1efef">
  ...
  <form class="row g-3" enctype="multipart/form-data"
    ...
    <div class="col-md-12">
      <label for="sizename" class="form-label">Cỡ:</label>
      <input type="text" class="form-control" id="pname" name="txtsizename" placeholder="Cỡ nhỏ" required>
    </div>
    <div class="mb-12">
      <label for="sizedesc" class="form-label">Mô tả:</label>
      <textarea class="form-control" name="txtsizedesc" id="catedesc" rows="3"
        placeholder="Diện tích vừa 20m2"></textarea>
    </div>
    <div class="col-12">
